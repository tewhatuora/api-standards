...
<ApiStandard id="HNZAS_MUST_have_compliance" type="MUST">API providers **MUST** provide compliance tests that API consumers are required to pass in order to onboard to In Confidence or higher-level APIs.</ApiStandard>
