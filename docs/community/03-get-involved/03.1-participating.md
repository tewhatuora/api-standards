...
To search discussions, just open the [Discussions](https://github.com/tewhatuora/api-standards/discussions) tab on the Health NZ Standards GitHub repository home page.
...
You can raise an issue by clicking on the `Raise issue` button in the upper right hand corner on the Standards website or navigating directly to the [Issues](https://github.com/tewhatuora/api-standards/issues) tab on the Health NZ Standards GitHub repository home page.
...
To search issues, just open the [Issues](https://github.com/tewhatuora/api-standards/issues) tab on the Health NZ Standards GitHub repository home page.
