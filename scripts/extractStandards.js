...
function extractDataFromHTML(filePath, htmlContent, excludeDraft) {
...
function processHTMLFile(filePath, excludeDraft) {
  console.log(`Processing file: ${filePath}`);
  const htmlContent = fs.readFileSync(filePath, "utf-8");
  return extractDataFromHTML(filePath, htmlContent, excludeDraft);
}
